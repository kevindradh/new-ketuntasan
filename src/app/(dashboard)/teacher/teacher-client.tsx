...
export function TeacherDashboardClient({ sheets, teacherId, teacherSubjectIds }: TeacherDashboardClientProps) {
    ...
    const CHART_COLORS = ['#006A4E', '#0D9C76', '#21BA92', '#47D1AC', '#A6F2DE']
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-emerald-700">{myItems.length - completedItems.length}</p>
                            </div>
                            <div className="p-3 bg-emerald-50 rounded-xl">
                ...
                <Card className="border-0 shadow-sm bg-emerald-700 text-white">
                    ...
                    <CardContent className="space-y-4">
                        <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20">
                            <p className="text-sm text-emerald-100 mb-1">Kelas dengan Ketuntasan Tertinggi</p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20">
                            <p className="text-sm text-emerald-100 mb-1">Perlu Perhatian</p>
                            <p className="text-xl font-bold">
                        ...
                        <div className="pt-4">
                            <Button asChild variant="secondary" className="w-full bg-white text-emerald-700 hover:bg-white/90">
                                <Link href="/teacher/completion-sheets">
