...
export function TeacherImportWizard() {
    ...
    const downloadTemplate = () => {
        const csvContent = "data:text/csv;charset=utf-8," + "full_name,email,phone\nBudi Santoso,budi@sekolah.sch.id,08123456789\nSiti Aminah,siti@sekolah.sch.id,08987654321"
        ...
        <Dialog open={open} onOpenChange={(v) => { setOpen(v); if (!v) reset() }}>
            ...
            <DialogContent className="sm:max-w-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Import data guru secara massal menggunakan file CSV.
                    </DialogDescription>
                </DialogHeader>
                        ...
                        <div className="bg-slate-50 p-4 rounded-lg flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500">Gunakan template ini</p>
                                </div>
                            </div>
